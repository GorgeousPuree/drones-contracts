...
contract("HpprsProjectOrchestrator", (accounts) => {
    ...
    it('Check mint gas', async () => {
        const gasEstimate = await hpprsProjectOrchestrator.mintDrone.estimateGas(3, {value: web3.utils.toWei(String(0.333), 'ether')});
    ...
    it('Check premint gas', async () => {
        ...
        const gasEstimate = await hpprsProjectOrchestrator.preMintDrone.estimateGas(3, '0x1eaab5cd42aab991cbb056aa7cb0cfca667a52665f35c16f03772ab462c919816f96a8762f82bbb326ed1b3e3ea6e534117bc97a73a323beff081f48c6c9b0911b', {value: web3.utils.toWei(String(0.297), 'ether')});
        const gasPrice = web3.eth.getGasPrice();
        console.log(gasEstimate);
    })
